        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastTotpStep = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagClass = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AltText = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecoveryCodes_AdminUsers_AdminUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadMinutesOverridden = table.Column<bool>(type: "INTEGER", nullable: false),
                    FeaturedMediaId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    OgImageId = table.Column<int>(type: "INTEGER", nullable: true),
                    TwitterCardType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_MediaFiles_FeaturedMediaId",
                        column: x => x.FeaturedMediaId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Articles_MediaFiles_OgImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaFiles_StoredName",
                table: "MediaFiles",
                column: "StoredName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RecoveryCodes_AdminUserId",
                table: "RecoveryCodes",
                column: "AdminUserId");
